...
import { getProductById, getPublicProducts } from '../api'
...
function ProductDetailPage() {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      ...
      try {
        const detailsData = await getProductById(id)
                    ...
                    images.map((image, index) => {
                      ...
                      return (
                        <button
                          ...
                          className={`overflow-hidden rounded-md border ${selectedImageIndex === index ? 'border-brand-500' : 'border-slate-200'
                            }`}
                        >
                          {thumbUrl ? (
                ...
                {similarProducts.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className='rounded-xl border border-slate-200 p-2 text-left hover:border-brand-400'
                    >
